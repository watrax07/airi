const messages = {
    es: {
        noPermissions: 'No tienes permisos para banear a miembros.',
        mentionUser: 'Debes mencionar a un usuario para banear.',
        banReason: 'Has sido baneado por un administrador.',
        banTitle: 'Usuario Baneado',
        banDescription: 'ha sido baneado del servidor.',
        reasonTitle: 'Razón:',
        banError: 'Hubo un error al intentar banear al usuario.',
    ...
    en: {
        ...
        banDescription: 'has been banned from the server.',
        reasonTitle: 'Reason:',
        banError: 'There was an error trying to ban the user.',
    ...
    fr: {
        ...
        banDescription: 'a été banni du serveur.',
        reasonTitle: 'Raison:',
        banError: 'Une erreur s\'est produite lors de la tentative de bannir l\'utilisateur.',
